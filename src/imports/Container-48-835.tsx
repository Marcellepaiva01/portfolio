...
function Button() {
  return (
    <div className="bg-[#00bc7d] h-[35.99px] relative rounded-[8px] shrink-0 w-[155.899px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon />
        <p className="-translate-x-1/2 absolute font-['Arial:Regular',sans-serif] leading-[20px] left-[94.46px] not-italic text-[14px] text-center text-white top-[5.98px]">Nova Transação</p>
      </div>
    </div>
  );
}
